...
const char* const BIP39_WORDLIST[] = {
    ...
    "humor", "hundred", "hungry", "hunt", "hurdle", "hurt", "husband", "hybrid",
    ...
    "opera", "opinion", "oppose", "option", "orange", "orbit", "orchard", "organ",
    ...
    "setup", "seven", "shadow", "shaft", "shallow", "share", "shame", "shark",
    "sharp", "sheep", "sheet", "shell", "sheriff", "shield", "shift", "shine",
    ...
    "submit", "subway", "success", "such", "sudden", "suffer", "sugar", "suit",
